...
| Phase 1 — Backend parity foundation | In progress | Core OpenAPI/RLS loop is working. Household profile, member routes, active week pointer, week-plan event vocabulary, shopping-state compatibility, and recipe community/saved slices are complete. |
